...
const Room = ({ room }) => {
  ...
  return <div className='bg-white shadow-2xl min-h-[500px] group'>
    ...
    {/* details */}
    <div
      className='bg-white shadow-lg max-w-[300px] mx-auto h-[60px] -translate-y-1/2 flex justify-center items-center uppercase font-tertiary tracking-[1px] font-semibold text-base'>
